...
v0.1 ships one concrete monitor: :class:`~loopcanary.monitors.metr_prompt.METRPromptMonitor`,
...
from loopcanary.monitors.metr_prompt import METRPromptMonitor  # noqa: E402
