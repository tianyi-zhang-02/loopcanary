...
:class:`~loopcanary.core.events.ReasoningEvent`,
:class:`~loopcanary.core.events.ToolCallEvent`,
:class:`~loopcanary.core.events.ObservationEvent`, and
:class:`~loopcanary.core.events.ScoringEvent`. The unified ordered list
...
Benchmark-specific adapters (see :mod:`loopcanary.benchmarks`) parse the
...
class StepType(StrEnum):
    ...
    .. deprecated::
       Use the :data:`~loopcanary.core.events.TrajectoryEvent` variants
       (:class:`~loopcanary.core.events.ReasoningEvent`,
       :class:`~loopcanary.core.events.ToolCallEvent`,
       :class:`~loopcanary.core.events.ObservationEvent`,
       :class:`~loopcanary.core.events.ScoringEvent`). Retained for one
...
class FileEdit(BaseModel):
    ...
    .. deprecated::
       Encode as a :class:`~loopcanary.core.events.ToolCallEvent` (the
       edit invocation) followed by a
       :class:`~loopcanary.core.events.ObservationEvent` carrying the
...
class ShellCommand(BaseModel):
    ...
    .. deprecated::
       Encode as a :class:`~loopcanary.core.events.ToolCallEvent`
       (``tool_name="shell"``) followed by a
       :class:`~loopcanary.core.events.ObservationEvent` carrying
...
class Trajectory(BaseModel):
    ...
    def from_dir(cls, path: Path) -> Trajectory:
        ...
        on a manifest file at ``path / 'loopcanary.json'``.
        """
