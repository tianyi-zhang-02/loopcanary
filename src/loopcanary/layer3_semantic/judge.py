...
1. Builds prompt messages via :mod:`loopcanary.layer3_semantic.prompts`,
   incorporating Layer 1 and Layer 2 findings as context.
2. Queries the tier-1 provider for a
   :class:`~loopcanary.core.verdict.SemanticVerdict`.
3. Consults
   :class:`~loopcanary.layer3_semantic.escalation.EscalationPolicy` to
...
:class:`~loopcanary.core.verdict.SemanticVerdict` per trajectory —
...
from loopcanary.core.verdict import SemanticVerdict, SyntacticFinding, WorkspaceFinding
