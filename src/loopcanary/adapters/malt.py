...
:class:`~loopcanary.core.trajectory.Trajectory` populated with discriminated
:data:`~loopcanary.core.events.TrajectoryEvent` variants.
...
from loopcanary.core.trajectory import HarnessResult, Trajectory
