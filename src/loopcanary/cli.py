...
* ``loopcanary run`` — load MALT trajectories, apply the structural
...
from loopcanary.adapters.malt import load_malt_split
from loopcanary.core.trajectory import Trajectory
from loopcanary.monitors.metr_prompt import METRPromptMonitor
from loopcanary.report import ReportCard, ScoreRecord, compute_report
from loopcanary.transformations import apply_structural_battery
...
def main() -> None:
    """Module-level entry point used by ``python -m loopcanary``."""
    app()
