...
:class:`~loopcanary.core.verdict.AuditVerdict` and feed the Layer 3
judge as context.

Submodules:

* :mod:`loopcanary.layer1_workspace.sandbox` — Docker sandbox.
* :mod:`loopcanary.layer1_workspace.fs_differ` — filesystem diff.
* :mod:`loopcanary.layer1_workspace.process_tracer` — subprocess tracing.
"""
