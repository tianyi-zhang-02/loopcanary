...
:class:`~loopcanary.layer2_syntactic.code_extractor.CodeEdit` instances
and the catalog from
:func:`~loopcanary.layer2_syntactic.exploit_signatures.get_all_signatures`,
it parses each edit's ``after_source`` and returns one
:class:`~loopcanary.core.verdict.SyntacticFinding` per matched
signature.
"""

from __future__ import annotations

from loopcanary.core.verdict import SyntacticFinding
from loopcanary.layer2_syntactic.code_extractor import CodeEdit
from loopcanary.layer2_syntactic.exploit_signatures import (
    ExploitSignature,
    get_all_signatures,
)
