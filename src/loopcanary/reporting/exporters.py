...
Exporters accept either :class:`~loopcanary.core.verdict.AuditVerdict`
records, an :class:`~loopcanary.reporting.leaderboard.IntegrityLeaderboard`,
or a :class:`~loopcanary.reporting.leaderboard.ComparisonReport`, and
...
from loopcanary.core.verdict import AuditVerdict
from loopcanary.reporting.leaderboard import ComparisonReport, IntegrityLeaderboard
