...
|---|---|---|
| Package skeleton | `src/loopcanary/__init__.py` exposes `__version__` | ✅ |
...
c21b0d3  chore: scaffold loopcanary project structure
```
...
One test. It asserts `isinstance(loopcanary.__version__, str)` and that it's non-empty.
